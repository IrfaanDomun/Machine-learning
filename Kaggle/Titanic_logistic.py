...
# Proportion of the values in predictions which 
# are the exact same as the values in titanic["Survived"]
accuracy = len(titanic["Survived"][titanic["Survived"] == predictions])/float(len(predictions))
